...
A the bottom of the dashboard, you will be able to explore the raw data in the format table with the possibility of highlighting cells, deleting rows and filtering the columns with keywords.
