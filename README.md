...
### Skip the pipeline
If you have previously generated BUSCO, CheckM2, GTDB-Tk2, GUNC or QUAST files and want to use them display the dashboard, we have developed the script `skip_pipeline.py`. By using this script you will be able to obtain the final_df.tsv file to use as input. You can run the followin command:

```bash
 BIgMAG/skip_pipeline.py example.csv path/to/store/the/file 
```
