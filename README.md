...
### Skip the pipeline
If you have previously generated BUSCO, CheckM2, GTDB-Tk2, GUNC or QUAST files and want to use them display the dashboard, we have developed the script `skip_pipeline.py`, which is able to concatenate the files into the required *final_df.tsv* by BIgMAG. You can run the following command:
